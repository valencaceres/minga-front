...
const Navbar = () => {
    ...
    return (
        <div className={`contenedor ${isOpen && "open"}`}>
            <div className={`navbar ${isOpen && "open"}`}>
                ...
                <div className={`nav_items ${isOpen && "open"}`}>
                    <h2 className={`otracosa ${isOpen && "open"}`}>
                        pepito@petito.com
                    </h2>
                    <div className="links">
                        {is_online ? (
                            <>
                                ...
                                <Anchor className="anchor" to={"/comics"}>
                                    Comics
                                </Anchor>
                                <Anchor className="anchor" to={"/comics/me"}>
                                    My Comics
                                </Anchor>
                                <Anchor className="anchor" to={"/new-author"}>
                                    New Author
                                </Anchor>
                                <Anchor className="anchor" to={"/new-chapter"}>
                                    New Chapter
                                </Anchor>
                                <Anchor className="anchor" to={"/new-cia"}>
                                    New Company
                                </Anchor>
                                <Anchor className="anchor" to={"/edit-profile"}>
                                    Edit Profile
                                </Anchor>
                            </>
                        ) : (
                        ...
                        {is_online ? (
                            ...
                            <>
                                <Anchor className="anchor" to={"/signup"}>
                                    Sign Up
                                </Anchor>
                                <Anchor className="anchor" to={"/signin"}>
                                    Sign In
                                </Anchor>
                            </>
                        )}
        ...
        <div className={`navbar ${isOpen && "open"}`}>
            ...
            <Anchor className="anchor" to={"/admin"}>AdminPanel</Anchor>
