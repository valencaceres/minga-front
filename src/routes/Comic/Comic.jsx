    ...
    <>
      ...
      <button className='emoji'>&#128525;</button>
          ...
          <div className="buttons">
            {chapter ? (
              <button onClick={handleManga} className="btn-white">
                Manga
              </button>
            ) : (
              <button onClick={handleManga} className="btn-blue">
                Manga
              </button>
            )}
            {chapter ? (
              <button onClick={handleChapters} className="btn-blue">
                Chapter
              </button>
            ) : (
              <button onClick={handleChapters} className="btn-white">
                Chapter
              </button>
            )}
          </div>
          ...
          {chapter ? (
            ...
            <div className="descriptioncontent">
              ...
              <p className="description">
                {comic.comics.response?.description}
              </p>
            </div>
          )}
        </div>
